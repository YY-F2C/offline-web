...
export const MUZHI_PADDING_Android = {
  '30': { top: 1.00, bottom: 0.67 },
  '33': { top: 1.33, bottom: 1.00 },
  '36': { top: 1.00, bottom: 0.67 },
  '39': { top: 0.67, bottom: 1.00 },
  '42': { top: 1.00, bottom: 1.33 },
  '45': { top: 1.33, bottom: 1.00 },
  '48': { top: 1.67, bottom: 1.33 },
  '51': { top: 1.67, bottom: 1.67 },
  '54': { top: 1.33, bottom: 1.67 },
  '57': { top: 1.67, bottom: 1.33 },
  '60': { top: 1.67, bottom: 1.67 },
  '63': { top: 1.67, bottom: 2.00 },
  '66': { top: 1.67, bottom: 1.67 },
  '69': { top: 1.67, bottom: 1.67 },
  '72': { top: 2.00, bottom: 2.00 },
  '75': { top: 2.00, bottom: 2.00 },
  '78': { top: 2.00, bottom: 2.33 },
  '81': { top: 2.33, bottom: 2.33 },
  '84': { top: 2.33, bottom: 2.33 },
  '87': { top: 2.33, bottom: 2.67 },
  '90': { top: 2.67, bottom: 2.67 },
}



export const MUZHI_PADDING_IOS = {
  '24': { top: 0.67, bottom: 1.00 },
  '27': { top: 1.00, bottom: 1.00 },
  '30': { top: 1.00, bottom: 1.00 },
  '33': { top: 1.00, bottom: 1.33 },
  '36': { top: 1.00, bottom: 1.33 },
  '39': { top: 1.00, bottom: 1.67 },
  '42': { top: 1.33, bottom: 1.67 },
  '45': { top: 1.33, bottom: 1.67 },
  '48': { top: 1.67, bottom: 1.67 },
  '51': { top: 1.67, bottom: 1.67 },
  '54': { top: 1.67, bottom: 2.00 },
  '57': { top: 1.67, bottom: 2.33 },
  '60': { top: 1.67, bottom: 2.33 },
  '63': { top: 2.00, bottom: 2.33 },
  '66': { top: 2.00, bottom: 2.33 },
  '69': { top: 2.33, bottom: 2.33 },
  '72': { top: 2.33, bottom: 2.33 },
  '75': { top: 2.00, bottom: 3.00 },
  '78': { top: 2.33, bottom: 3.00 },
  '81': { top: 2.33, bottom: 3.00 },
  '84': { top: 2.67, bottom: 3.00 },
  '87': { top: 2.67, bottom: 3.00 },
  '90': { top: 2.33, bottom: 3.67 },
  '93': { top: 2.67, bottom: 3.33 },
  '96': { top: 3.00, bottom: 3.33 },
  '99': { top: 3.33, bottom: 3.33 },
  '102': { top: 3.67, bottom: 3.00 },
  '105': { top: 4.00, bottom: 3.00 }
}