    ...
    <ul key={flag} className="text-items">
      ...
      <li className="text-item">
        <CopiableInput
          ...
          label={t('font size')}
          value={formattedNumber(items.fontSize, globalSettings)}
        />
      </li>
      <li className="text-item">
        <CopiableInput
          ...
          value={formattedNumber(items.letterSpacing, globalSettings)}
        />
      </li>
      <li className="text-item">
        <CopiableInput
          ...
          label={t('line height')}
          value={
            items.lineHeightUnit === 'PIXELS' ? formattedNumber(items.lineHeight, globalSettings) : items.lineHeight
          }
        />
      </li>
