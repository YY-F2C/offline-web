...
function canvasWrapper(Canvas) {
  class CanvasWrapper extends React.Component {
    ...
    render() {
      ...
      const {percentageMode, initialWidth, initialHeight, frameBound, posX, posY, scale, spacePressed, isDragging} =
        this.state
      const style = {
        top: posY,
        left: posX,
      ...
      return (
        <div ref={this.container} className="main-canvas">
          <div className="canvas-steper">
            <span className="steper-button steper-minus" onClick={() => this.onStep(-1)}>
              <Minus size={14} />
            </span>
            <Tooltip
              trigger={['click']}
            ...
            <span className="steper-button steper-plus" onClick={() => this.onStep(1)}>
              <Plus size={14} />
            </span>
          </div>
          <Tooltip
          ...
          <div
            ...
            style={{
              ...style,
              cursor: spacePressed || isDragging ? 'grab' : 'default',
            }}
          >
            <Canvas
              {...this.props}
