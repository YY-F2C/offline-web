  ...
  render() {
    ...
    return (
      <div className="form">
        ...
        <div className="form-item form-item-horizontal">
          <label htmlFor="unit" className="item-label">
            {t('unit')}
          </label>
          <select
            name="unit"
        ...
        {baseVisible && (
          <div className="form-item form-item-horizontal">
            <label htmlFor="rem-base" className="item-label">
              {t('(r)em base')}
            </label>
            <InputNumber
              name="remBase"
        ...
        <div className="form-item form-item-horizontal">
          ...
          <select name="numberFormat" className="input" value={numberFormat} onChange={this.handleChange}>
